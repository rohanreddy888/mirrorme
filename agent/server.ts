...
import agentsApiRoutes from "./routes/agents-api.js";
...
app.use("/api/agents-api", agentsApiRoutes);
...
app.listen(PORT, () => {
  ...
  console.log(`Agents API endpoint: http://localhost:${PORT}/api/agents-api`);
